            ...
            <View className="flex-1 bg-white/70">
                ...
                >
                    ...
                    <View className="px-4 py-6 space-y-6">
                        ...
                        {/* 🛻 Safari Ride Comfort */}
                        <View className="flex-col md:flex-row-reverse items-center space-y-4 md:space-y-0 md:space-x-reverse md:space-x-4">
                            <Image
                                source={require("../assets/pic1.jpg")}
                                className="w-full md:w-48 h-48 rounded-xl md:ml-2"
                                resizeMode="cover"
                            />
                            <Text className="text-sm text-gray-800 border border-green-800 p-4 rounded-xl bg-white shadow-md">
                                ...
                                :
                                {"\n"}{"\n"}
                                🦓 "A safari is not just a trip...
                                It’s a journey through time,
                                where the Earth breathes wild and free."
                                {"\n"}{"\n"}
                                🦁 "Every roar in the distance,
                                every rustle in the grass —
                                a reminder that this is their kingdom, not ours."
                                {"\n"}{"\n"}
                                🌅 "Golden skies, endless plains,
                        ...
                        <Image
                            ...
                            className="w-72 h-52 rounded-xl mx-auto"
                            resizeMode="cover"
                        />
